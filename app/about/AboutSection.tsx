        ...
        <Section className={`${openSans.className} gap-6 md:gap-10 mt-20 md:mt-50`}>
            <div className="flex flex-col gap-6 text-center md:text-left">
                ...
                <p className="text-neutral-content opacity-60 text-sm md:text-base/6 font-normal">
                    At MyDigitalLawyer®️, we provide strategic, practical, and commercially focused legal solutions for businesses, creatives, individuals, and organisations navigating an increasingly complex world.
